...
const Homepage = () => {
  return (
    <div className="min-h-[calc(100vh-40px)] w-full bg-gradient-to-r from-[#d3dcf5] via-[#cadbf4] to-[#d7f4ca] flex flex-col items-center justify-center text-center px-4 mt-[8vh]">
